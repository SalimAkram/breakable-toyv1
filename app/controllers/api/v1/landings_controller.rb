...
#figure out a cheaper API solution
    ...
    # cafe_search=HTTParty.get("https://api.foursquare.com/v2/venues/search?client_id=4UIEV1H5EUZNXIYHJEVTS352JXDT3VPIMSD51TNB5NEMVU0C&client_secret=LURJGW5NORLJSYPQHNBT1V5VBGHZQZR4LR01GPT23B1IOSFT&ll=42.3395328,-71.1589888&radius=4000&query=coffee_shop&v=20201120")
    # cafe_search=HTTParty.get("https://api.foursquare.com/v2/venues/search?client_id=#{ENV["CLIENT_ID"]}&client_secret=#{ENV["CLIENT_SECRET"]}&ll=42.3395328,-71.1589888&radius=4000&query=coffee_shop&v=20201120")
