...
class Cafe
  ...
  def self.cafe_search
    cafes = []

    cafe_search=HTTParty.get("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=42.3395328,-71.1589888&radius=4000&type=cafe&keyword=coffee_shop&coffee=&key=#{ENV["GOOGLE_KEY"]}") 
